/*
  ...
  - You are about to drop the `FlatType` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the column `flatTypeId` on the `Listing` table. All the data in the column will be lost.
