...
useSeoMeta({
	title: 'Обработка персональных данных — защита ваших персональных данных',
	description: 'Обработка персональных данных: как мы собираем, используем и защищаем ваши персональные данные. Ознакомьтесь с условиями обработки информации и вашими правами как пользователя.'
})
</script>
	...
	<div class="wrapper">
		...
		<div class="mt-6">
			...
			<div class="Text">
				...
				<p>2) полученных в связи с заключением договора, стороной которого является субъект персональных данных (в т.ч. любой пользователь информационной системы «Аура Тур», выступающий как на стороне лица, публикующего объявления в системе, так и на стороне лица, осуществляющего бронь по опубликованному объявлению);</p>
				<p></p>
